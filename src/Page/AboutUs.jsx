  ...
  return (
    <MemberDiv>
      ...
      <p>
        ...
        поважати не тільки численних коучів, а і себе і свій досвід. САНХ це
        суто рієлторська організація, ми не утримуємо адміністративний апарат,
        всі проблеми вирішуємо разом. Тому у САНХ не існує і не буде існувати
        ніяких членських внесків і поборів. Свідоцтва та посвідчення члена САНХ
      ...
      <ul>
        ...
        <li>
          ...
          втілює, але САНХ є організацією тільки реально практикуючих ріелторів.
