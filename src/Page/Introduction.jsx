...
export const Introduction = () => {
  return (
    <MemberDiv>
      ...
      <ol>
        <li>
          Ріелтор подає заяву на вступ до лав САНХ, на ім'я голови
          сертифікаційної ради САНХ. Форма заяви вільна.
          <br />
      ...
      <span>
        ...
        щоб в Агенції було не менше двох ріелтор членів САНХ. Всі свідоцтва
          ...
          <details id="pay">
            ...
            <table>
              ...
              <tr>
                ...
                <td className="sp">друк для САНХ</td>
              </tr>
            </table>
          </details>
        </li>
